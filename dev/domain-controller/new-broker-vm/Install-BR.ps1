    ...
    Node "localhost"
    {
        ...
        Script Install_SumoCollector
        {
            ...
            SetScript  = {
                ...
                $sumo_collector_json = "$using:gitLocation/sumo-broker-vm.conf"	
		...
		Script Install_Tomcat
        {
            ...
            SetScript  = {
				...
				####### Is this really needed? I don't think so. or, TODO: Make this a parameter and what to do about DC HA? Names? ############
