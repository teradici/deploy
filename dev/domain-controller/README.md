...
* If deployment fails with MSFT_xRemoteFile errors or issues in relation to the application gateway, then creating a new deployment in a new, empty resource group should correct it. This error randomnly occurs and is not related to incorrect parameters. 
