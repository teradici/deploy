...
<a target="_blank" href="https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fteradici%2Fdeploy%2Fantar%2Fdev%2Fdomain-controller%2Fazuredeploy.json">
...
```
 ...
 1. Create the local parameters file by calling
   ```
   Invoke-Webrequest -Uri "https://raw.githubusercontent.com/teradici/deploy/antar/dev/domain-controller/azuredeploy.parameters.json" -OutFile "my.azuredeploy.parameters.json"
   ```
...
New-AzureRMResourceGroupDeployment -DeploymentName "ad1" -ResourceGroupName $azureRGName -TemplateFile "https://raw.githubusercontent.com/teradici/deploy/antar/dev/domain-controller/azuredeploy.json" -TemplateParameterFile "my.azuredeploy.parameters.json"
