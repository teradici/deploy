...
# minimum number of minutes machine must be idle before shutting down
MIN_IDLE_WAIT_TIME=5

# maximum number of minutes machine must be idle before shutting down
...
# will set the globals wait_minutes and poll_interval
